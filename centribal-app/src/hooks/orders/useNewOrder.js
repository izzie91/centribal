...
const useNewOrder = ({ lang, langLabels }) => {
  ...
  const getProducts = useCallback(async () => {
    await productService.fetchProducts(langLabels.errorMessage);
  ...
  const newOrder = useCallback(
    async (data) => {
      await orderService.createOrder(data, langLabels.createdMessage, langLabels.errorMessage);
